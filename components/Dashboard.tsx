  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h3 className="text-lg lg:text-xl font-black text-slate-800 tracking-tight">Visão da Nath</h3>
            ...
            <button
              ...
              className={`px-5 py-2.5 rounded-full text-xs font-black whitespace-nowrap transition-all border shrink-0 ${
                activeCategory === cat 
                  ...
                  : 'bg-white text-slate-500 border-slate-200 hover:border-blue-600'
              }`}
            >
              {cat}
            </button>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6">
        {[
          ...
          <div key={idx} className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col justify-between h-36">
            <h3 className="text-slate-400 text-xs font-black tracking-widest">{kpi.label}</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
        ...
        <div className="lg:col-span-2 bg-white p-7 rounded-2xl shadow-sm border border-slate-200 flex flex-col h-[450px]">
          <h3 className="text-base font-black text-slate-800 mb-6 uppercase tracking-tight">RANKING DE INTERESSE</h3>
          <div className="flex-1 w-full min-h-0">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={filteredProducts} layout="vertical" margin={{ top: 0, right: 30, left: 20, bottom: 0 }}>
                ...
                <Tooltip 
                  cursor={{fill: '#f8fafc'}}
                  contentStyle={{ borderRadius: '12px', border: 'none', boxShadow: '0 10px 15px -3px rgba(0,0,0,0.1)', fontSize: '13px', fontWeight: 'bold' }}
                />
        ...
        <div className="bg-white p-7 rounded-2xl shadow-sm border border-slate-200 flex flex-col h-[450px]">
          <h3 className="text-base font-black text-slate-800 mb-1 uppercase tracking-tight">PERFIL COMPRADOR</h3>
      ...
      <div className="bg-white p-7 rounded-2xl shadow-sm border border-slate-200">
        <h3 className="text-base font-black text-slate-800 mb-8 uppercase tracking-tight">CRUZAMENTO DE DEMANDA</h3>
